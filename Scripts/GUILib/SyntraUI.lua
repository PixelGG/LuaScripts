...
local Theme = {
    ...
    Elevated      = Color3.fromRGB(28,  28,  44),
    -- Akzent / Neon
    Accent        = Color3.fromRGB(108, 60,  255),
    AccentDark    = Color3.fromRGB(68,  32,  190),
    AccentGlow    = Color3.fromRGB(140, 95,  255),
    AccentSoft    = Color3.fromRGB(108, 60,  255),   -- für schwache Highlights
    -- Text
    TextPrimary   = Color3.fromRGB(242, 242, 255),
    TextSecondary = Color3.fromRGB(155, 155, 185),
    TextDisabled  = Color3.fromRGB(80,  80,  110),
    -- Zustände
    Success       = Color3.fromRGB(48,  214, 126),
    Warning       = Color3.fromRGB(255, 185, 40),
    Error         = Color3.fromRGB(255, 68,  68),
    Info          = Color3.fromRGB(55,  160, 255),
    -- Rahmen & Sonstiges
    Border        = Color3.fromRGB(48,  44,  78),
    BorderLight   = Color3.fromRGB(70,  65,  105),
...
function SyntraUI:CreateWindow(options)
    ...
    local winSize  = options.Size     or UDim2.new(0, 600, 0, 440)
    local winPos   = options.Position or UDim2.new(0.5, -300, 0.5, -220)
    ...
    local function makeWinBtn(offsetX, symbol, normalColor)
        ...
        local lbl = Util.Make("TextLabel", {
            ...
            Font                   = Enum.Font.GothamBold,
            TextSize               = 9,
            TextColor3             = Color3.fromRGB(30, 20, 40),
            BackgroundTransparency = 1,
            Size                   = UDim2.new(1, 0, 1, 0),
            TextTransparency       = 1,
            ZIndex                 = 7,
        ...
        btn.MouseEnter:Connect(function()
            Util.Tween(circle, {BackgroundColor3 = normalColor:Lerp(Color3.new(1,1,1), 0.3)}, 0.12)
    ...
    local CloseBtn,    closeCircle    = makeWinBtn(-18, "✕", Color3.fromRGB(255, 75, 75))
    local MinimizeBtn, minimizeCircle = makeWinBtn(-38, "−", Color3.fromRGB(255, 190, 45))
    local MaximizeBtn, maximizeCircle = makeWinBtn(-58, "+", Color3.fromRGB(48, 200, 100))
    ...
    Util.Padding(10, 10, 6, 6, TabList)
    Util.Make("UIListLayout", {
        SortOrder = Enum.SortOrder.LayoutOrder,
    ...
    function Window:CreateTab(tabOpts)
        ...
        -- Tab-Eintrag
        local tab = { _btn = TabBtn, _page = Page, _indicator = Indicator }
        ...
        local function activateTab()
            ...
            Page.Visible = true
            Util.Tween(TabBtn, {BackgroundTransparency = 0.88, TextColor3 = Theme.TextPrimary}, 0.15)
        ...
        TabBtn.MouseEnter:Connect(function()
            if Window._activeTab ~= tab then
                Util.Tween(TabBtn, {BackgroundTransparency = 0.94}, 0.1)
            end
        end)
        ...
        function Tab:AddButton(bOpts)
            ...
            btn.MouseButton1Click:Connect(function(x, y)
                ...
                task.delay(0.07, function()
                    Util.Tween(c, {BackgroundColor3 = Theme.Secondary}, 0.18)
                end)
                bCallback()
            end)
            btn.MouseEnter:Connect(function()
            ...
            btn.MouseLeave:Connect(function()
                Util.Tween(c, {BackgroundColor3 = Theme.Secondary}, 0.12)
            end)
...
function SyntraUI:ShowLoadingScreen(options)
    ...
    local guiParent = getGuiParent()
    local old = guiParent:FindFirstChild("SyntraUI_Loading")
    if old then old:Destroy() end
    ...
    local logoFrame = Util.Make("Frame", {
        ...
        Position = UDim2.new(0.5, -56, 0.5, -118),
        BackgroundColor3 = Theme.Secondary,
        BackgroundTransparency = 0.05,
        BorderSizePixel = 0,
        ZIndex = 2,
    }, root)
    Util.Corner(24, logoFrame)
    Util.Stroke(Theme.BorderLight, 1, logoFrame)
    ...
    local statusLabel = Util.Make("TextLabel", {
        ...
        Position = UDim2.new(0, 20, 0.5, 48),
        TextXAlignment = Enum.TextXAlignment.Center,
        ZIndex = 2,
    }, root)
    ...
    local barBack = Util.Make("Frame", {
        ...
        Position = UDim2.new(0.5, -130, 0.5, 86),
        BackgroundColor3 = Theme.Tertiary,
        BorderSizePixel = 0,
        ZIndex = 2,
    }, root)
    ...
    Util.Tween(root, {BackgroundTransparency = 0}, 0.25)
